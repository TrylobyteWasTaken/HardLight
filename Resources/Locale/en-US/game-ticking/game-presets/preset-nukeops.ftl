...
nukeops-welcome =
    ...
    Intel note: Colonial Command operates a passive sector threat detection grid. You have at least 60 minutes before it may flag the possibility of nuclear operatives in the sector — do not count on staying undetected indefinitely.
